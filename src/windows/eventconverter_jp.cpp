...
// for JP Keyboard
uchar EventConverter_JP::getVKCode(QKeyEvent *keyEvent)
{
  ...
  case Qt::Key_Henkan:			// Convert
	return VK_CONVERT;
  case Qt::Key_Muhenkan:		// NonConvert
	return VK_NONCONVERT;

  case Qt::Key_Zenkaku_Hankaku:	// Zenkaku_Hankaku
	return VK_KANJI;
  ...
  default:					// NOT support key
	if (outputLog){
	  ...
	  cout << "[EventConverter_JP] Unknown Key: " << hex << key << endl << flush;
	  cout.flags(flags);
	}
	return VK_NONE_00;
  }
...
// get name
QString EventConverter_JP::getEventConverterName()
{
	return (QString)"JP";
}
