...
==============================
 ...
 (1) 「ファイル」メニュー
     ...
     ファイルをサーバに転送します。転送するファイルを選択するためにファイルダイアログが
     開きます。
...
----------------------------------------------------------------------
 ...
 -mode5 : ファイル転送、クリップボード共有をサポートしません。古いサーバに接続するために指定します。
...
----------------------------------------------------------------------
 ...
 (2) 英語環境でメニューにアクセラレータキーが表示されないことがあります。
