...
[その他変更]
 ...
 1. AVX2命令が利用可能な場合にAVX2命令を利用するように変更

 2. Qt5.12.7でビルドするように変更(Linux(x86)版のみ5.4.2のまま)

 3. CELTのリンク時のライブラリ名を"celt0"から"celt"へ変更

 4. Windows XP対応32bit版(Qt5.6.3)を作るための環境整備
