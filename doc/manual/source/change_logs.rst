...
[その他変更]
 ...
 1. フレームレートの制御機構の変更(デスクトップ画像描画タイミングの変更)

 2. SIMD命令(SSE/NEON)の利用コードを標準で有効化

 3. 「設定」ダイアログに「SIMD命令 (SSE/NEON) を利用する」を追加

 4. Windows版に同梱しているOpenSSL DLLを1.0.2oへ更新
