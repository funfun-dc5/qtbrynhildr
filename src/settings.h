...
#define QTB_TOUCHPANELINTERFACETYPE_BOTTOM_LEFTCENTER	2
#define QTB_TOUCHPANELINTERFACETYPE_TOP_LEFTCENTER		3
#define QTB_TOUCHPANELINTERFACETYPE_NUM					4
#if defined(Q_OS_IOS)
#define QTB_TOUCHPANELINTERFACETYPE_DEFAULT		QTB_TOUCHPANELINTERFACETYPE_BOTTOM_LEFTCENTER
