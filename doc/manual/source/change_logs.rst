...
* [その他変更]
 ...
 1. インストーラパッケージ作成ツールをバージョンアップ(InnoSetup 5.5.6) (Windows版)

 2. Windows 10 (x64/x86)をサポートOSに追加
...
* [その他変更]
 ...
 1. サウンド再生の安定性の確保のためQtの環境を5.5.0からQt5.4.2へバージョンダウン
